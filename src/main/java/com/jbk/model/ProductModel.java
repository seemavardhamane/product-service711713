...
@Pattern(regexp="^[\\w\"\\s]+$", message="Product name should contain alphabets, numeric, spaces, double quotes, and underscores.")
	...
	public ProductModel(long productId,
			@NotBlank(message = "Product name should not blank") @Pattern(regexp = "^[\\w\"\\s]+$", message = "Product name should contain alphabets, numeric, spaces, double quotes, and underscores.") String productName,
